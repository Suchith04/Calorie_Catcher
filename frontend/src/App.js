      ...
      {mobileMenuOpen && token && (
        <div className="md:hidden bg-orange-700 border-t border-orange-500">
          <div className="px-4 py-3 space-y-2">
            <Link to="/dashboard" onClick={() => setMobileMenuOpen(false)} className="block text-white hover:bg-orange-600 px-3 py-2 rounded">
              Dashboard
            </Link>
            <Link to="/history" onClick={() => setMobileMenuOpen(false)} className="block text-white hover:bg-orange-600 px-3 py-2 rounded">
              History
            </Link>
            <Link to="/debt" onClick={() => setMobileMenuOpen(false)} className="block text-white hover:bg-orange-600 px-3 py-2 rounded">
              Debt Tracker
            </Link>
            <button onClick={handleLogout} className="w-full text-left text-white hover:bg-orange-600 px-3 py-2 rounded">
              Logout
            </button>
          </div>
        </div>
